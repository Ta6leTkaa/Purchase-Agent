...
def test_reservation_id_survives_mapper_round_trip() -> None:
    mission = make_mission()
    ...
    assert model.reservation_id == "provider-reservation-123"
    assert restored_mission.reservation_id == "provider-reservation-123"
